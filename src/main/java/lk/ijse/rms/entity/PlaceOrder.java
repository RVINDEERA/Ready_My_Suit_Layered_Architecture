...
public class PlaceOrder {
    ...
    public PlaceOrder(String orderId, String date, String customerId, String tailorId, double fullAmount, double advance, double balance, String status, String completeDate, List<OrderCartTm> orderCartTmList) {
