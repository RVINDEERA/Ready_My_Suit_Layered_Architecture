...
public class Trouser {
    ...
    public Trouser(String trmId, String customerId, String date, String length, String wast, String seat, String halfSeat, String knee, String bottm, String crotch) {
        this.trmId = trmId;
