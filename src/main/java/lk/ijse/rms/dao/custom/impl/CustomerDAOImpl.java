...
public class CustomerDAOImpl implements CustomerDAO {
    ...
    public String genarateNextCustomerId() throws SQLException, ClassNotFoundException {
    ...
    public CustomerDto searchCustomerId(String customerSearch) throws SQLException, ClassNotFoundException {
